...
def list_products_by_name():
    ...
    This endpoint will return a list of all Product names
    """
    app.logger.info("Request to list all Product names")

    products = Product.query.all()
    product_names = [product.name for product in products]

    app.logger.info("Returning %d product names", len(product_names))
    return jsonify(product_names), status.HTTP_200_OK
